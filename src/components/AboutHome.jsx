        ...
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="mb-10 text-lg leading-9 text-neutral-700">
              Ofrecemos clases de danza urbana, flamenco, música,
              actividades senior, gym y otras propuestas enfocadas al
              bienestar, el aprendizaje y la diversión.
            </p>
  ...
  Descubrir actividades
          ...
          <div className="relative">
            ...
            <img
              ...
              className="h-[650px] w-full rounded-[36px] object-cover"
            />
